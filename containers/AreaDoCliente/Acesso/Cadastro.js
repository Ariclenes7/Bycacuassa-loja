...
class CadastroContainer extends Component {
    ...
    validate() {
        const {
            ...
            local, numero, bairro, cidade, estado
        } = this.state;
        const erros = {};
        ...
        if (!CPF || CPF.length !== 14) erros.CPF = "Preencha aqui com o seu B.I";
        /*if (CPF && CPF.length === 14 && !validateCPF(CPF))
            erros.CPF = "Preencha aqui com o seu B.I corretamente";*/
    ...
    render() {
        const {
            ...
            local, numero, complemento, bairro, cidade, estado,
            aviso, erros
        } = this.state;
        return (
            <div className="Cadastro-Container">
                ...
                <div className="form-cadastro">
                    ...
                    <FormSimples erro={erros.CPF}
                        ...
                        value={CPF} name="CPF" type="text" placeholder="B.I" />
                    ...
                    <div className="flex horizontal">
                        <div className="flex-1">
                            <FormSimples label="Distrito" erro={erros.cidade}
                                onChange={(e) => this.onChange('cidade', e.target.value)}
                                value={cidade} name="cidade" placeholder="Ex: Distrito do Belas" />
                        </div>
                        <div className="form-input">
                            ...
                            <select
                                ...
                                <option>Selecione a sua Província</option>
